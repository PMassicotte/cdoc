...
coords2location = function(long, lat)
{  
  
  points <- data_frame(long = long, lat = lat)
  
  countriesSP <- readOGR("dataset/shapefiles/world/", "All_Merge")
  ...
  as.character(indices$Label)   # returns the continent (7 continent model)
