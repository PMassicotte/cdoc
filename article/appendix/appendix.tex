...
\input{../../article/tables/anova_acdom}
\input{../../article/tables/tukey_acdom}

\clearpage
\newpage

\subsubsection*{Dissolved organic carbon}
\input{../../article/tables/anova_doc}
\input{../../article/tables/tukey_doc}

\clearpage
\newpage

\subsubsection*{Specific UV absorbance}
\input{../../article/tables/anova_suva350}
\input{../../article/tables/tukey_suva350}
