...
\begin{figure}[h]
	\centering
	\includegraphics[scale = 1]{../../graphs/fig9}
	\caption{Averaged SUVA\textsubscript{350} calculated using observations from river ecosystem as a function of the distance to the closest ocean. The vertical error bars represent the standard deviation. The labels on the bottom show the number of observation in each bin.}
\end{figure}
