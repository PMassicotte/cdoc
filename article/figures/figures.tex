...
\begin{figure}[h]
	...
	\caption{Averaged SUVA\textsubscript{350} calculated using observations from river ecosystem as a function of the distance to the closest ocean. The blue line represented the fitted linear model and the shaded area the 95\% confidence interval. The vertical error bars represent the standard deviation. The labels on the bottom show the number of observation in each distance bin.}
\end{figure}
