...
\begin{figure}[h]
	...
	\caption{World map showing the spatial distribution of the observations extracted from the literature ($n = 12808$).}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale = 1]{../../graphs/fig3}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale = 0.8]{../../graphs/fig4}
