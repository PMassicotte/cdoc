...
\begin{figure}[h]
	...
	\caption{Averaged SUVA\textsubscript{350} calculated using observations from river ecosystem as a function of the distance to the closest ocean. The vertical error bars represent the standard deviation.}
\end{figure}
